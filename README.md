...
Players can redeem their tokens for in-game items by calling the redeem function.
Players can burn their tokens using the burn function when they are no longer needed.
Authors
Anushka kumari 
